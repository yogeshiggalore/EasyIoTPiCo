...
void ModbusRTUMaster::Get_Config_Parameters_From_Memory(void){

}

void ModbusRTUMaster::Start(void){
...
void ModbusRTUMaster::Prepare_Packet(void){
...
uint16_t ModbusRTUMaster::Is_Slave_DataReceived(void){
                ...
                if(ui16ModbusRxCounter > (ui16ModbusExpectedBytes-1)){
                    ...
                    if(ui8ModbusTaskCompleteFlag == 0){
                        if(uint8ModbusTimeoutFlag){
                            ...
                            //Serial1.print("Modbus Error code ");
                            //Serial1.println(ui8ModbusErrorCode,HEX);
                        }
                    }
                }
...
void IRAM_ATTR ModbusRTUMaster::Check_Modbus_Timer(void){
...
uint8_t ModbusRTUMaster::Modbus_RunCommand(uint8_t aui8Buffer[],uint8_t ui8ByteToSent,uint8_t BytesExpected,uint8_t* RxByteCount, uint16_t TimeOutIntervalInMs, uint16_t *ResponseTimeout){
