...
void ESPMemory::Update_All(void){
    ModTCPS.ui8CoilStatus = EEPROM.read(MEMORY_COIL_REG_BYTE);
    
    ModTCPS.aui16HoldingRegister[0] =  EEPROM.read(MEMORY_HOLD_REG1_HIGH_BYTE);
    ModTCPS.aui16HoldingRegister[0] = ModTCPS.aui16HoldingRegister[0] << 8;
    ModTCPS.aui16HoldingRegister[0] = ModTCPS.aui16HoldingRegister[0] | EEPROM.read(MEMORY_HOLD_REG1_LOW_BYTE);

    ModTCPS.aui16HoldingRegister[1] =  EEPROM.read(MEMORY_HOLD_REG2_HIGH_BYTE);
    ModTCPS.aui16HoldingRegister[1] = ModTCPS.aui16HoldingRegister[1] << 8;
    ModTCPS.aui16HoldingRegister[1] = ModTCPS.aui16HoldingRegister[1] | EEPROM.read(MEMORY_HOLD_REG2_LOW_BYTE);

    ModTCPS.aui16HoldingRegister[2] =  EEPROM.read(MEMORY_HOLD_REG3_HIGH_BYTE);
    ModTCPS.aui16HoldingRegister[2] = ModTCPS.aui16HoldingRegister[2] << 8;
    ModTCPS.aui16HoldingRegister[2] = ModTCPS.aui16HoldingRegister[2] | EEPROM.read(MEMORY_HOLD_REG3_LOW_BYTE);

    ModTCPS.aui16HoldingRegister[3] =  EEPROM.read(MEMORY_HOLD_REG4_HIGH_BYTE);
    ModTCPS.aui16HoldingRegister[3] = ModTCPS.aui16HoldingRegister[3] << 8;
    ModTCPS.aui16HoldingRegister[3] = ModTCPS.aui16HoldingRegister[3] | EEPROM.read(MEMORY_HOLD_REG4_LOW_BYTE);
}
