...
*
* Description:
* This is header file for modbus ascii master. All the functions related to
* Modbus ascii master are implemented in this file
*
* Owner:
* Yogesh M Iggalore
*
...
public:
    ...
    void IRAM_ATTR Check_Modbus_Timer(void);
    ...
    uint8_t Modbus_RunCommand_ASCII(uint8_t aui8Buffer[],uint8_t ui8ByteToSent,uint8_t BytesExpected,uint8_t* RxByteCount, uint16_t TimeOutIntervalInMs, uint16_t *ResponseTimeout);
...
extern ModbusASCIIMaster Modbus;
#endif
#endif