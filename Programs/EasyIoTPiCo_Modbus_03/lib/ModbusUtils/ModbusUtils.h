...
#define MODBUS_ASCII_ERR_NONE						    0x00
#define MODBUS_ASCII_ERR_CRC							0xFF
#define MODBUS_ASCII_ERR_TIMEOUT						0xFE
#define MODBUS_ASCII_ERR_INVALID_REG_ADDRESS	        0xFD
#define MODBUS_ASCII_ERR_INVALID_RESPONSE_LEN		    0xFC
#define MODBUS_ASCII_ERR_INVALID_MODBUS_COMMAND		0xFB
#define MODBUS_ASCII_ERR_INVALID_FUNC		            0xF9
#define MODBUS_ASCII_ERR_INVALID_DATA_VALUE		    0xF8
#define MODBUS_ASCII_ERR_GATEWAY_FAILED		        0xF7
#define MODBUS_ASCII_METI_NO_NEW_DATA		            0xF6
#define MODBUS_ASCII_ERR_UNKNOWN		                0xF1
...
//Standard locations
#define MODBUS_ASCII_LOCATION_DEV_NUMBER			    0
#define MODBUS_ASCII_LOCATION_FUNC_CODE			    1	
#define MODBUS_ASCII_LOCATION_FUNC_ERROR			    2	

//Query - Locations
#define MODBUS_ASCII_LOCATION_REG_START_LO		    2
#define MODBUS_ASCII_LOCATION_REG_START_HI		    3
#define MODBUS_ASCII_LOCATION_REG_COUNT_LO		    4
#define MODBUS_ASCII_LOCATION_REG_COUNT_HI		    5
#define MODBUS_ASCII_LOCATION_CRC_LO		            6
#define MODBUS_ASCII_LOCATION_CRC_HI		            7

#define MODBUS_ASCII_LOCATION_BYTES_COUNT		        2
    
#define MODBUS_ASCII_LOCATION_BYTES_TO_FOLLOW		    6
#define MODBUS_ASCII_WRITE_RETRIES		            0
#define MODBUS_ASCII_WRITE_EXPECTED_BYTES		        8
...
public:
    ...
    uint8_t Modbus_ExpectedBytes_ASCII(uint8_t aui8Buffer[]);
