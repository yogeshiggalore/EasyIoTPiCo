/*******************************************************************************
* Project Name: EasyIoTPiCo_Telegram_01
*
* Version: 1.0
*
* Description:
* In this project esp8266 uses telegram to control led pin
* Owner:
* Yogesh M Iggalore
*
********************************************************************************
* No Copyrights (2020-21) EasyIoTPiCo
*******************************************************************************/
#include <Arduino.h>
...
void setup(){
	...
	bot._debug = true;
	/* initialize digital LED1_PIN as an output. */
